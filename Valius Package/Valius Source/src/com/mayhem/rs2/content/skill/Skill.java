...
import static com.mayhem.rs2.content.skill.Skills.DUNGEONEERING;
...
import com.mayhem.rs2.entity.player.net.out.impl.SendSkill;
...
public class Skill {
	...
	/**
	 * Gets an experience multiplyer based on worn Equipment
	 *
	 * @param id
	 *			  The id of the skill adding experience too	 	
	 * @return
	 */
	private double getExperienceMultiplyer(int skillId) {
		
		double multiplyer = 1.0D;
		
		switch (skillId) {
		
		case 0://Attack
			if (player.getEquipment().contains(4202)) {
				multiplyer *= 1.05;
			}
		case 1://Defence
			if (player.getEquipment().contains(4202)) {
		...
		case 5://Prayer
			if (player.getEquipment().contains(13117)) {
				multiplyer *= 1.05;
			}
			break;
		...
		case 10://Fishing
			if (player.getEquipment().contains(13258) && player.getEquipment().contains(13259) && player.getEquipment().contains(13260) && player.getEquipment().contains(13261)) {
				multiplyer *= 1.30;
			}
			if (player.getEquipment().contains(13129)) {
				multiplyer *= 1.05;
			}
			if (player.getEquipment().contains(13258)) {
				multiplyer *= 1.05;
			}
			if (player.getEquipment().contains(13259)) {
				multiplyer *= 1.05;
			}
			if (player.getEquipment().contains(13260)) {
				multiplyer *= 1.05;
			}
			if (player.getEquipment().contains(13261)) {
				multiplyer *= 1.05;
			}
			break;
		...
		case 11: //Firemaking
			...
			if (player.getEquipment().contains(20708) && player.getEquipment().contains(20704) && player.getEquipment().contains(20706) && player.getEquipment().contains(20710) && player.getEquipment().contains(20712)) { 
				multiplyer *= 1.30; 
			}//Pyromancer hood 5% bonus
			if (player.getEquipment().contains(20708)) {
				multiplyer *= 1.05;
			}//Pyromancer top
			if (player.getEquipment().contains(20704)) {
				multiplyer *= 1.05;
			}//Pyromancer bottoms
			if (player.getEquipment().contains(20706)) {
				multiplyer *= 1.05;
			}//Pyromancer boots
			if (player.getEquipment().contains(20710)) {
				multiplyer *= 1.05;
			}//Pyromancer gloves
			if (player.getEquipment().contains(20712)) {
				multiplyer *= 1.05;
			}
			break;
				
		case 12://Crafting
			if (player.getEquipment().contains(13133)) {
				multiplyer *= 1.05;
			}
			break;
			
		case 13://Smithing
			if (player.getEquipment().contains(13104)) {
				multiplyer *= 1.05;
			}
			if (player.getEquipment().contains(13105)) {
				multiplyer *= 1.07;
			}
			if (player.getEquipment().contains(13106)) {
				multiplyer *= 1.10;
			}
		...
		case 14://Mining
			if (player.getEquipment().contains(11136)) {
				multiplyer *= 1.05;
			}
			if (player.getEquipment().contains(12013)) {
				multiplyer *= 1.05;
			}
			if (player.getEquipment().contains(12014)) {
				multiplyer *= 1.05;
			}
			if (player.getEquipment().contains(12015)) {
				multiplyer *= 1.05;
			}
			if (player.getEquipment().contains(12016)) {
				multiplyer *= 1.05;
			}
			break;
		...
		case 17://Thieving
			if (player.getEquipment().contains(13121)) {
				multiplyer *= 1.05;
			}
			if (player.getEquipment().contains(5553) || player.getEquipment().contains(5554) || player.getEquipment().contains(5555) || player.getEquipment().contains(5556) || player.getEquipment().contains(5557)) {
				multiplyer *= 1.30;
			}
		...
		case 18://slayer
			if (player.getEquipment().contains(11865)) {
				multiplyer *= 1.05D;
			}
			if (player.getEquipment().contains(19649)) {
				multiplyer *= 1.05D;
			}
			if (player.getEquipment().contains(19641)) {
				multiplyer *= 1.05D;
			}
			if (player.getEquipment().contains(19645)) {
				multiplyer *= 1.05D;
			}
		...
		case 19://Farming
			if (player.getEquipment().contains(13125)) {
				multiplyer *= 1.05;
			}
			break;
			
		case 22://hunter
			if (player.getEquipment().contains(11259)) {
				multiplyer *= 1.10;
			}
			break;
	...
	public double addExperience(int id, double experience) {
		...
		//Modes
		if (player.isExtreme()) {
			experience = experience * Skills.EXPERIENCE_RATES[id] * 1.0D / 6;
		}
		else {
