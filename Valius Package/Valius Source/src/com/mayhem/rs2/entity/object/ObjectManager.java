...
public class ObjectManager {
	...
	public static void declare() {
		...
		/** Home Area */
		spawnWithObject(410, 1639, 3661, 0, 10, 0);//Lunar Altar
		spawnWithObject(6552, 1635, 3661, 0, 10, 0);//Ancient Altar
		spawnWithObject(409, 1632, 3661, 0, 10, 2);//prayer Altar	
		spawnWithObject(4875, 1635, 3685, 0, 10, 5);//Food stall
		spawnWithObject(4876, 1636, 3685, 0, 10, 5);//General stall
		spawnWithObject(4874, 1637, 3685, 0, 10, 5);//Crafting stall
		spawnWithObject(4877, 1638, 3685, 0, 10, 5);//Magic stall
		spawnWithObject(4878, 1639, 3685, 0, 10, 5);//Scmitar stall
		spawnWithObject(2191, 1627, 3675, 0, 10, 1);//Crystal chest
		...
		spawnWithObject(29170, 1650, 3662, 0, 10, 0);//max cape
		spawnWithObject(29171, 1649, 3662, 0, 10, 0);//max cape
		spawnWithObject(29175, 1648, 3662, 0, 10, 0);//max cape
		spawnWithObject(29172, 1647, 3662, 0, 10, 0);//max cape
		spawnWithObject(29174, 1646, 3662, 0, 10, 0);//max cape
		spawnWithObject(29173, 1645, 3662, 0, 10, 0);//max cape
		spawnWithObject(14503, 1627, 3658, 0, 10, 0);
		spawnWithObject(14503, 1630, 3658, 0, 10, 0);
		spawnWithObject(27282, 1627, 3670, 0, 10, 3);
