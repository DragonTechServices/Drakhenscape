...
import com.mayhem.rs2.content.shopping.impl.TriviaShop;
	...
	public static final void finishClickNpc(Player player, int option, Mob mob) {
		...
		case 1:// NPC FIRST CLICK
			...
			case 276:// Trivia shop
				...
				player.getClient().queueOutgoingPacket(new SendMessage("@blu@ You have " + player.triviaPoints + " Trivia points."));
				break;
		...
		case 2:// NPC SECOND CLICK
			...
			case 5527:// Achievement
				...
				player.getClient().queueOutgoingPacket(new SendMessage("@blu@ You have " + player.achievementPoints + " Achievement points."));
				break;
			case 1603://Mage Arena
			...
			case 5787:// Agility
				...
				break;
			case 7042:// Swagster
				player.start(new OptionDialogue("Valius Bucks Store 1", p -> {
					player.getShopping().open(94);
				} , "Valius Bucks Store 2", p -> {
					player.getShopping().open(90);
				} , "Valius Bucks Store 3", p -> {
			...
			case 306:// tutorial npc
				...
				} , "Server tour(Show several areas around Valius)", p -> {
