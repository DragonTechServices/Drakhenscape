...
public final class Loader extends JFrame {
    ...
    private static final String CLIENT_URL = "http://valius.org/play/Valius%20Client.jar";
    private static final String CLIENT_DIRECTORY = System.getProperty("user.home") + "/ValiusCacheV5/";
                    ...
                    SwingWorker<Void, Void> worker = new SwingWorker<Void, Void>() {
                        ...
                        protected Void doInBackground() throws Exception {
                            ...
                            try {
                                ...
                                frame.status.setText("Error loading client...Please post a bug report at www.valius.com.");
    ...
    public Loader() {
        ...
        status = new JLabel("Getting the latest client updates...This could take a few moments...");
