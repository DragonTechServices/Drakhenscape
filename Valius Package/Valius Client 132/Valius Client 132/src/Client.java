...
public class Client extends ClientEngine {
	...
	private Sprite mapIcon1;
	private Sprite mapIcon2;
	private Sprite mapIcon3;
	private Sprite mapIcon4;
	...
	private void drawTimers() {
		...
		if (this.freezeTimer != -1) {
			if (!this.freezeToggle) {
				this.freezeBar.draw24BitSprite(476, i);
			} else {
				this.freezeBar.draw24BitSprite(440, i);
		...
		if (this.vengTimer != -1) {
			if (!this.vengToggle) {
				this.vengBar.draw24BitSprite(476, i);
			} else {
				this.vengBar.draw24BitSprite(440, i);
	...
	private void drawChatArea() {
		...
		if (messagePromptRaised) {
					...
					if ((chatType == 1 || chatType == 2) && (chatType == 1 || publicChatMode == 0 || publicChatMode == 1 && isFriendOrSelf(s1))) {
						if (chatTypeView == 1 || chatTypeView == 0) {
							...
							if (playerRights == 1) {
								...
								modIcons[2].drawSprite(xPos, yPos - 12 + yOffset);
								xPos += 16;
							} else if (playerRights == 4) {
								modIcons[3].drawSprite(xPos, yPos - 12 + yOffset);
								xPos += 16;
							} else if (playerRights == 5) {
								modIcons[4].drawSprite(xPos, yPos - 12 + yOffset);
								xPos += 16;
							} else if (playerRights == 6) {
								modIcons[5].drawSprite(xPos, yPos - 12 + yOffset);
								xPos += 16;
							} else if (playerRights == 7) {
								modIcons[6].drawSprite(xPos, yPos - 12 + yOffset);
								xPos += 16;
							} else if (playerRights == 8) {
								modIcons[7].drawSprite(xPos, yPos - 12 + yOffset);
								xPos += 16;
							} else if (playerRights == 11) {
								modIcons[9].drawSprite(xPos, yPos - 12 + yOffset);
								xPos += 16;
							} else if (playerRights == 12) {
								modIcons[10].drawSprite(xPos, yPos - 12 + yOffset);
								xPos += 16;
							} else if (playerRights == 13) {
								modIcons[11].drawSprite(xPos, yPos - 12 + yOffset);
								xPos += 16;
							} else if (playerRights == 14) {
								modIcons[13].drawSprite(xPos, yPos - 12 + yOffset);
								xPos += 16;
							}  else if (playerRights == 15) {
								modIcons[15].drawSprite(xPos, yPos - 12 + yOffset);
								xPos += 16;
							}
			...
			if (myPrivilege == 0) {
				...
				modIcons[0].drawSprite(10 + xPos, 122 + yPos + yOffset);
				...
				newRegularFont.drawBasicString(inputString + "*", 23 + textDrawingArea.getTextWidth(myPlayer.title + (title.equals(null) ? "" : " ") + playerName + ": ") + 13, 136 + yOffset - 2, changeChatArea ? 0x7FA9FF : 255, changeChatArea ? 0 : -1);
					...
					modIcons[1].drawSprite(10 + xPos, 122 + yPos + yOffset);
					cacheSprite[347].drawSprite(textDrawingArea.getTextWidth(myPlayer.title + (title.equals(null) ? "" : " ") + playerName + ": ") + 18, 124 + yOffset);
					xPos += 15;
					newRegularFont.drawBasicString(title + playerName + "", 23, 136 + yOffset - 2, changeChatArea ? 0xFFFFFF : 0, changeChatArea ? 0 : -1);
					textDrawingArea.method385(changeChatArea ? 0xFFFFFF : 0, ": ", 136 + yOffset - 2, 38 + textDrawingArea.getTextWidth(myPlayer.title + (title.equals(null) ? "" : " ") + playerName));
					...
					modIcons[2].drawSprite(10 + xPos, 122 + yPos + yOffset);
					cacheSprite[347].drawSprite(textDrawingArea.getTextWidth(myPlayer.title + (title.equals(null) ? "" : " ") + playerName + ": ") + 18, 124 + yOffset);
					xPos += 15;
					newRegularFont.drawBasicString(title + playerName + "", 23, 136 + yOffset - 2, changeChatArea ? 0xFFFFFF : 0, changeChatArea ? 0 : -1);
					textDrawingArea.method385(changeChatArea ? 0xFFFFFF : 0, ": ", 136 + yOffset - 2, 38 + textDrawingArea.getTextWidth(myPlayer.title + (title.equals(null) ? "" : " ") + playerName));
					...
					modIcons[3].drawSprite(10 + xPos, 122 + yPos + yOffset);
					cacheSprite[347].drawSprite(textDrawingArea.getTextWidth(myPlayer.title + (title.equals(null) ? "" : " ") + playerName + ": ") + 18, 124 + yOffset);
					xPos += 15;
					newRegularFont.drawBasicString(title + playerName + "", 23, 136 + yOffset - 2, changeChatArea ? 0xFFFFFF : 0, changeChatArea ? 0 : -1);
					textDrawingArea.method385(changeChatArea ? 0xFFFFFF : 0, ": ", 136 + yOffset - 2, 38 + textDrawingArea.getTextWidth(myPlayer.title + (title.equals(null) ? "" : " ") + playerName));
					...
					modIcons[4].drawSprite(10 + xPos, 122 + yPos + yOffset);
					cacheSprite[347].drawSprite(textDrawingArea.getTextWidth(myPlayer.title + (title.equals(null) ? "" : " ") + playerName + ": ") + 18, 124 + yOffset);
					xPos += 15;
					newRegularFont.drawBasicString(title + playerName + "", 23, 136 + yOffset - 2, changeChatArea ? 0xFFFFFF : 0, changeChatArea ? 0 : -1);
					textDrawingArea.method385(changeChatArea ? 0xFFFFFF : 0, ": ", 136 + yOffset - 2, 38 + textDrawingArea.getTextWidth(myPlayer.title + (title.equals(null) ? "" : " ") + playerName));
					...
					modIcons[5].drawSprite(10 + xPos, 122 + yPos + yOffset);
					cacheSprite[347].drawSprite(textDrawingArea.getTextWidth(myPlayer.title + (title.equals(null) ? "" : " ") + playerName + ": ") + 18, 124 + yOffset);
					xPos += 15;
					newRegularFont.drawBasicString(title + playerName + "", 23, 136 + yOffset - 2, changeChatArea ? 0xFFFFFF : 0, changeChatArea ? 0 : -1);
					textDrawingArea.method385(changeChatArea ? 0xFFFFFF : 0, ": ", 136 + yOffset - 2, 38 + textDrawingArea.getTextWidth(myPlayer.title + (title.equals(null) ? "" : " ") + playerName));
					...
					modIcons[6].drawSprite(10 + xPos, 122 + yPos + yOffset);
					cacheSprite[347].drawSprite(textDrawingArea.getTextWidth(myPlayer.title + (title.equals(null) ? "" : " ") + playerName + ": ") + 18, 124 + yOffset);
					xPos += 15;
					newRegularFont.drawBasicString(title + playerName + "", 23, 136 + yOffset - 2, changeChatArea ? 0xFFFFFF : 0, changeChatArea ? 0 : -1);
					textDrawingArea.method385(changeChatArea ? 0xFFFFFF : 0, ": ", 136 + yOffset - 2, 38 + textDrawingArea.getTextWidth(myPlayer.title + (title.equals(null) ? "" : " ") + playerName));
					...
					modIcons[7].drawSprite(10 + xPos, 122 + yPos + yOffset);
					cacheSprite[347].drawSprite(textDrawingArea.getTextWidth(myPlayer.title + (title.equals(null) ? "" : " ") + playerName + ": ") + 18, 124 + yOffset);
					xPos += 15;
					newRegularFont.drawBasicString(title + playerName + "", 23, 136 + yOffset - 2, changeChatArea ? 0xFFFFFF : 0, changeChatArea ? 0 : -1);
					textDrawingArea.method385(changeChatArea ? 0xFFFFFF : 0, ": ", 136 + yOffset - 2, 38 + textDrawingArea.getTextWidth(myPlayer.title + (title.equals(null) ? "" : " ") + playerName));
					...
					modIcons[8].drawSprite(10 + xPos, 122 + yPos + yOffset);
					cacheSprite[347].drawSprite(textDrawingArea.getTextWidth(myPlayer.title + (title.equals(null) ? "" : " ") + playerName + ": ") + 18, 124 + yOffset);
					xPos += 15;
					newRegularFont.drawBasicString(title + playerName + "", 23, 136 + yOffset - 2, changeChatArea ? 0xFFFFFF : 0, changeChatArea ? 0 : -1);
					textDrawingArea.method385(changeChatArea ? 0xFFFFFF : 0, ": ", 136 + yOffset - 2, 38 + textDrawingArea.getTextWidth(myPlayer.title + (title.equals(null) ? "" : " ") + playerName));
					...
					modIcons[9].drawSprite(10 + xPos, 122 + yPos + yOffset);
					cacheSprite[347].drawSprite(textDrawingArea.getTextWidth(myPlayer.title + (title.equals(null) ? "" : " ") + playerName + ": ") + 18, 124 + yOffset);
					xPos += 15;
					newRegularFont.drawBasicString(title + playerName + "", 23, 136 + yOffset - 2, changeChatArea ? 0xFFFFFF : 0, changeChatArea ? 0 : -1);
					textDrawingArea.method385(changeChatArea ? 0xFFFFFF : 0, ": ", 136 + yOffset - 2, 38 + textDrawingArea.getTextWidth(myPlayer.title + (title.equals(null) ? "" : " ") + playerName));
					...
					modIcons[10].drawSprite(10 + xPos, 122 + yPos + yOffset);
					cacheSprite[347].drawSprite(textDrawingArea.getTextWidth(myPlayer.title + (title.equals(null) ? "" : " ") + playerName + ": ") + 18, 124 + yOffset);
					xPos += 15;
					newRegularFont.drawBasicString(title + playerName + "", 23, 136 + yOffset - 2, changeChatArea ? 0xFFFFFF : 0, changeChatArea ? 0 : -1);
					textDrawingArea.method385(changeChatArea ? 0xFFFFFF : 0, ": ", 136 + yOffset - 2, 38 + textDrawingArea.getTextWidth(myPlayer.title + (title.equals(null) ? "" : " ") + playerName));
				...
				modIcons[11].drawSprite(10 + xPos, 122 + yPos + yOffset);
				cacheSprite[347].drawSprite(textDrawingArea.getTextWidth(myPlayer.title + (title.equals(null) ? "" : " ") + playerName + ": ") + 18, 124 + yOffset);
				xPos += 15;
				newRegularFont.drawBasicString(title + playerName + "", 23, 136 + yOffset - 2, changeChatArea ? 0xFFFFFF : 0, changeChatArea ? 0 : -1);
				textDrawingArea.method385(changeChatArea ? 0xFFFFFF : 0, ": ", 136 + yOffset - 2, 38 + textDrawingArea.getTextWidth(myPlayer.title + (title.equals(null) ? "" : " ") + playerName));
				...
				modIcons[13].drawSprite(10 + xPos, 122 + yPos + yOffset);
				cacheSprite[347].drawSprite(textDrawingArea.getTextWidth(myPlayer.title + (title.equals(null) ? "" : " ") + playerName + ": ") + 18, 124 + yOffset);
				xPos += 15;
				newRegularFont.drawBasicString(title + playerName + "", 23, 136 + yOffset - 2, changeChatArea ? 0xFFFFFF : 0, changeChatArea ? 0 : -1);
				textDrawingArea.method385(changeChatArea ? 0xFFFFFF : 0, ": ", 136 + yOffset - 2, 38 + textDrawingArea.getTextWidth(myPlayer.title + (title.equals(null) ? "" : " ") + playerName));
				...
				modIcons[15].drawSprite(10 + xPos, 122 + yPos + yOffset);
				cacheSprite[347].drawSprite(textDrawingArea.getTextWidth(myPlayer.title + (title.equals(null) ? "" : " ") + playerName + ": ") + 18, 124 + yOffset);
				xPos += 15;
				newRegularFont.drawBasicString(title + playerName + "", 23, 136 + yOffset - 2, changeChatArea ? 0xFFFFFF : 0, changeChatArea ? 0 : -1);
				textDrawingArea.method385(changeChatArea ? 0xFFFFFF : 0, ": ", 136 + yOffset - 2, 38 + textDrawingArea.getTextWidth(myPlayer.title + (title.equals(null) ? "" : " ") + playerName));
	...
	public void resetLogout() {
		...
		loggedIn = false;
		loginScreenState = 0;
		loginMessage1 = "Welcome to Valius";
	...
	private void loadTitleScreen() {
		...
		drawLoadingText(10, "Starting up Valius client");
		if (!aBoolean831) {
			drawFlames = true;
			aBoolean831 = true;
	...
	static {
		try {
			BACKGROUND = new Sprite(new URL("https://dl.dropboxusercontent.com/s/h8p0u9xtk613ll3/6.png"));
			LOADING_BAR_EMPTY = new Sprite(new URL("https://dl.www.dropboxusercontent.com/s/b8j6nufiie0yntz/frame.png"));
			LOADING_BAR_FULL = new Sprite(new URL("https://dl.dropboxusercontent.com/s/zymylp82c8yn8or/fullbar.png"));
		...
		for (int j = 0; j < 100; j++) {
			if (chatMessages[j] != null) {
				...
				if ((k == 3 || k == 7) && (k == 7 || privateChatMode == 0 || privateChatMode == 1 && isFriendOrSelf(s))) {
					...
					k1 += textDrawingArea.getTextWidth("From ");
					if (byte1 == 1) {
						modIcons[0].drawSprite(k1 - 3, l - 15);
						k1 += 12;
					} else if (byte1 == 2) {
						modIcons[1].drawSprite(k1 - 3, l - 15);
						k1 += 12;
					} else if (byte1 == 3) {
						modIcons[2].drawSprite(k1 - 3, l - 15);
						k1 += 12;
					} else if (byte1 == 4) {
						modIcons[3].drawSprite(k1 - 3, l - 15);
						k1 += 12;
					} else if (byte1 == 5) {
						modIcons[4].drawSprite(k1 - 3, l - 15);
						k1 += 12;
					} else if (byte1 == 6) {
						modIcons[5].drawSprite(k1 - 3, l - 15);
						k1 += 12;
					} else if (byte1 == 7) {
						modIcons[6].drawSprite(k1 - 3, l - 15);
						k1 += 12;
					} else if (byte1 == 8) {
						modIcons[7].drawSprite(k1 - 3, l - 15);
						k1 += 12;
					} else if (byte1 == 11) {
						modIcons[9].drawSprite(k1 - 3, l - 15);
						k1 += 12;
					} else if (byte1 == 12) {
						modIcons[10].drawSprite(k1 - 3, l - 15);
						k1 += 12;
					} else if (byte1 == 13) {
						modIcons[11].drawSprite(k1 - 3, l - 15);
						k1 += 12;
					}
	...
	public void login(String username, String password, boolean flag) {
		...
		try {
			...
			if (k == 6) {
				loginMessage1 = "Client is outdated.";
	...
	void startUp() {
		...
		drawSmoothLoading(1, "www.valius.org");
		...
		try {
			...
			drawSmoothLoading(250, "Don't forget to register on our active community forums! www.valius.org");
			...
			//OSRSData.load();
			this.freezeBar = cacheSprite[492];
			this.vengBar = cacheSprite[493];
			...
			mapIcon = new Sprite(mediaStreamLoader, "mapfunction", 5); //Bank
			mapIcon1 = new Sprite(mediaStreamLoader, "mapfunction", 19); //altar
			mapIcon2 = new Sprite(mediaStreamLoader, "mapfunction", 51); //Slayer master
			mapIcon3 = new Sprite(mediaStreamLoader, "mapfunction", 29); //thieving
			mapIcon4 = new Sprite(mediaStreamLoader, "mapfunction", 77); //donator shops
			mapIcon5 = new Sprite(mediaStreamLoader, "mapfunction", 66); //Guide
	...
	private void drawMinimap() {
		...
		for (int j5 = 0; j5 < anInt1071; j5++) {
			...
			markMinimap(mapIcon, ((1637 - baseX) * 4 + 2) - myPlayer.x / 32, ((3673 - baseY) * 4 + 2) - myPlayer.y / 32);//bank
			markMinimap(mapIcon1, ((1635 - baseX) * 4 + 2) - myPlayer.x / 32, ((3661 - baseY) * 4 + 2) - myPlayer.y / 32);//altar
			markMinimap(mapIcon1, ((1640 - baseX) * 4 + 2) - myPlayer.x / 32, ((3661 - baseY) * 4 + 2) - myPlayer.y / 32);//altar
			markMinimap(mapIcon2, ((1623 - baseX) * 4 + 2) - myPlayer.x / 32, ((3682 - baseY) * 4 + 2) - myPlayer.y / 32);//slayer master
			markMinimap(mapIcon3, ((1634 - baseX) * 4 + 2) - myPlayer.x / 32, ((3685 - baseY) * 4 + 2) - myPlayer.y / 32);//thieving
			markMinimap(mapIcon3, ((1639 - baseX) * 4 + 2) - myPlayer.x / 32, ((3685 - baseY) * 4 + 2) - myPlayer.y / 32);//thieving
			markMinimap(mapIcon4, ((1623 - baseX) * 4 + 2) - myPlayer.x / 32, ((3664 - baseY) * 4 + 2) - myPlayer.y / 32);//donator icon
			markMinimap(mapIcon5, ((1627 - baseX) * 4 + 2) - myPlayer.x / 32, ((3671 - baseY) * 4 + 2) - myPlayer.y / 32);//guide
			markMinimap(mapIcon6, ((1650 - baseX) * 4 + 2) - myPlayer.x / 32, ((3670 - baseY) * 4 + 2) - myPlayer.y / 32);//ironman
			...
			case 126:
				try {
					...
					if (text.startsWith("freezetimer:")) {
						args = text.split(":");
						this.freezeTimer = ((int) (Integer.parseInt(args[1])));
						this.pktType = -1;
						return true;
					}
					if (text.startsWith("vengtimer:")) {
						args = text.split(":");
						this.vengTimer = ((int) (Integer.parseInt(args[1])));
						this.pktType = -1;
						return true;
					}
	...
	private void processMinimapActions() {
		...
		if (Configuration.enableStatusOrbs) {
			...
			/*if (counterHover) {
				...
				cacheSprite[521].drawSprite(frameMode == ScreenMode.FIXED ? -3 : frameWidth - 210, frameMode == ScreenMode.FIXED ? 21 : 20);
			}*/
			if (worldHover) {
	...
	public void pushFeed(String entityName, int HP, int maxHP) {
		...
		entityAlpha = 255;
		//System.out.println("Entity feed hp: " + entityFeedHP + "Max hp: " + entityFeedMaxHP);
	}
