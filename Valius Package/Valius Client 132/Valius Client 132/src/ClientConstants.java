...
public class ClientConstants {
	 ...
	 */
	public final static String CLIENT_NAME = "Valius";
	 ...
	 */
	public final static String[] SERVER_IPS = { "158.69.192.213" };
	 ...
	 */
	public final static String ANNOUNCEMENT = "Welcome to Valius!";
